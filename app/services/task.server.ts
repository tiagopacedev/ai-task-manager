...
export async function findSimilarTasks(title: string, limit: number = 3, cutOff: number = 0.45) {
...
export async function storeTaskAsEmbeddings(taskId: string, taskData: TaskData) {
...
async function createEmbeddingsFromDocuments(taskId: string, chunks: Document[]) {
